...
def get_effective_contacts(person_id, age, pools, pooltype, pool_id, contact_rates,
    infectious_period_length, transmission_probability):
    ...
    for tp in transmission_probabilities:
        ...
        for person in population:
            ...
            hh_effective_contacts = get_effective_contacts(person["id"], person["age"],
                                                            ...
                                                            contact_rates, infectious_period_length, tp)
...
if __name__=="__main__":
    ...
    main(args.population_file, args.contact_matrix_file, args.infectious_period_length, args.transmission_probabilities)
